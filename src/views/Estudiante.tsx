...
import { getStudents } from "../services/estudianteService"
            ...
            <main className="mx-auto flex flex-col sm:flex-row m-auto dark:bg-slate-900">
                ...
                <div className=" mt-12 mx-6 w-full">
                    <div className="flex flex-col sm:flex-row sm:items-end gap-4 justify-end border-b-2 border-black dark:border-white pb-4 my-2">
                        ...
                        <div className="bg-slate-100 w-full sm:w-8 h-8 rounded-md border border-slate-300 dark:border-transparent flex flex-col justify-center items-center hover:bg-slate-300 dark:bg-slate-600 dark:text-white dark:hover:text-black"
                        >
                        ...
                        <div className="bg-slate-100 h-8 px-2 rounded-md border border-slate-300 dark:border-transparent flex gap-2 justify-center items-center hover:bg-slate-300 dark:bg-slate-600 dark:text-white dark:hover:text-black ">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" width="24" height="24" stroke-width="2">
                        ...
                        <div className="bg-indigo-700 text-white h-8 px-2 rounded-md flex gap-2 items-center hover:bg-slate-900 dark:hover:bg-indigo-400">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" width="24" height="24" stroke-width="2">
                        ...
                        <Link
                            to='registro/nuevo'
                            className='flex items-center rounded hover:bg-blue-900 px-3 py-2'
                        >
                            <p className="px-3">Nuevo</p>
                        </Link>
                    </div>
                    ...
                    <p className=" text-xl font-bold text-wrap my-4 dark:text-white">
                        Matricula general; incluye estudiantes de todos los cursos y niveles
                    </p>
